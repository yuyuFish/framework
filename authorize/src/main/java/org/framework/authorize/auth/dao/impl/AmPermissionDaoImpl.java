...
public class AmPermissionDaoImpl extends BaseDaoImpl implements AmPermissionDao {
	...
	public int save(AmPermission amPermission) {
		...
		int result=getSqlSession().insert("org.framework.authorize.auth.mapper.AmPermissionMapper.save", amPermission);
		if(LOG.isDebugEnabled()){
	...
	public int update(AmPermission amPermission) {
		...
		int result=getSqlSession().update("org.framework.authorize.auth.mapper.AmPermissionMapper.update", amPermission);
		if(LOG.isDebugEnabled()){
			LOG.debug(">>>>result:"+result);
		}
		return result;
	...
	public int deleteById(String permissionId) {
		...
		int result=getSqlSession().delete("org.framework.authorize.auth.mapper.AmPermissionMapper.deleteById", permissionId);
		if(LOG.isDebugEnabled()){
			LOG.debug(">>>>result:"+result);
		}
		return result;
	...
	public AmPermission getById(String permissionId) {
		...
		AmPermission result=getSqlSession().selectOne("org.framework.authorize.auth.mapper.AmPermissionMapper.getById", permissionId);
		if(LOG.isDebugEnabled()){
			LOG.debug(">>>>result:"+result);
		}
		return result;
	...
	public List<AmPermission> getAll() {
		List<AmPermission> result=getSqlSession().selectList("org.framework.authorize.auth.mapper.AmPermissionMapper.getAll");
		if(LOG.isDebugEnabled()){
	...
	public List<AmPermission> getByWhere(String whereSql, String paraKey,
		...
		List<AmPermission> result=getSqlSession().selectList("org.framework.authorize.auth.mapper.AmPermissionMapper.getByWhere",paraWarp);
		if(LOG.isDebugEnabled()){
			LOG.debug(">>>>result size:"+(result==null?"null":result.size()));
		}
	...
	@Override
	public List<AmPermission> getByWherePage(String whereSql, Long startIndex, Long size
		...
		List<AmPermission> result=getSqlSession().selectList("org.framework.authorize.auth.mapper.AmPermissionMapper.getByWherePage",paraWarp);
		if(LOG.isDebugEnabled()){
			LOG.debug(">>>>result size:"+(result==null?"null":result.size()));
		}
	...
	@Override
	public List<AmPermission> getByWherePage(String whereSql, Long startIndex,
